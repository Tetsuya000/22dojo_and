...
//import jp.gr.java.conf.tmproject.dojoandroid2022.presentation.ui.rodemap.section.RoadmapSectionViewModel
...
////        if (isMaster) {
////            val action =
////                RoadmapNodeFragmentDirections.navigateChildNodesToDetailMemo(selectedNode.id, selectedNode.title, "")
////            findNavController().navigate(action)
////        }
////        else {
